"""Gunicorn settings for 51crm.

nginx owns the public port (4000) and 443 and proxies here. A port can
only be bound once, so gunicorn listens on 4001, on loopback only —
